...
SFE_UBLOX_GNSS_SERIAL myGNSS; // ZED-F9x
...
void setup()
{
  ...
  // For the initial NEO-D9C's: connect using address 0x42
  while (myQZSS.begin(Wire, 0x42) == false)
  // For newer NEO-D9C's: use address 0x43
