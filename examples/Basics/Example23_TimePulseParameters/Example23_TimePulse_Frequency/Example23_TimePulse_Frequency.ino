...
void setup()
{
  ...
  // Here we are configuring TP1, but identical keys exist for TP2. See CFG-TP in u-blox_config_keys.h for more details.
  ...
  myGNSS.addCfgValset32(UBLOX_CFG_TP_FREQ_TP1, 2000); // Set the frequency/period to 2000Hz
  ...
  myGNSS.addCfgValset32(UBLOX_CFG_TP_FREQ_LOCK_TP1, 1000); // Set the frequency/period to 1000Hz
